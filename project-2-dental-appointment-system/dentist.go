...
var idNum = 0 // need handle concurrency issues when updating appt num
...
func (t *dentistHashTable) listAvailTime(name string, month int, date int) error {
	...
	info.timeAvail.month[month-1].day[date-1].InOrder()
